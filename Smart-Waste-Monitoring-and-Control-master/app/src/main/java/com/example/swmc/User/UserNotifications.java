...
public class UserNotifications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.userNotificationRecyclerView);
        recyclerView.setHasFixedSize(true);

        bottomNavigationView = findViewById(R.id.userBottomNavigationView);
        bottomNavigationView.setSelectedItemId(R.id.userNotifications);
        ...
        userNotificationsAdapter = new UserNotificationsAdapter(UserNotifications.this,notificationArrayList);
    ...
    private void getNotifications() {
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                userNotificationsAdapter.notifyDataSetChanged();
            }
    ...
    private void signOut() {
        ...
        if (check == true) {
            Toast.makeText(UserNotifications.this, "Signed Out Successfully!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(UserNotifications.this, MainActivity.class);
